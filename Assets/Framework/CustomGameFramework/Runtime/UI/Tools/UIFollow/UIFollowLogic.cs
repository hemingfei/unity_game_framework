...
namespace CustomGameFramework.Runtime
{
    public class UIFollowLogic : IReference
    {
        ...
        public void Set(Transform ui, Transform followTransform, Vector3 uiOffset, Vector3 positionOffset)
        {
            ...
            if (ui == null || followTransform == null)
            {
                return;
            }
        ...
        public void Update()
        {
            ...
            {
                if (_targetUI.position == Vector3.zero)
                {
                    return;
                }
            ...
            if (_bindMode == BindMode.None)
            {
                return;
            }

            Vector3 newPos = _targetPosition;

            if (_bindMode == BindMode.Transform && _targetTransform != null)
            {
                newPos = _targetTransform.position;
            }
