...
namespace Doozy.Engine.UI.Animation
{
    ...
    public class UIAnimations : ScriptableObject
    {
        ...
        {
            DisplayProgressBar("UIAnimations", "Initializing", 0.1f);
            Initialize();
            ...
            DisplayProgressBar("UIAnimations", "Update Show", 0.6f);
            Show.Update();
            DisplayProgressBar("UIAnimations", "Update Hide", 0.6f);
            Hide.Update();
            DisplayProgressBar("UIAnimations", "Update Loop", 0.7f);
            Loop.Update();
            DisplayProgressBar("UIAnimations", "Update Punch", 0.8f);
            Punch.Update();
            DisplayProgressBar("UIAnimations", "Update State", 0.9f);
            State.Update();
            DisplayProgressBar("UIAnimations", "Saving database", 1f);
            SetDirty(saveAssets);
            ClearProgressBar();
        }
