...
namespace UnityGameFramework.Runtime
{
    ...
    public class DefaultSoundAgentHelper : SoundAgentHelperBase
    {
        ...
        private EventHandler<ResetSoundAgentEventArgs> m_ResetSoundAgentEventHandler;
        ...
        private void Update()
        {
            if (!m_ApplicationPauseFlag && !IsPlaying && m_AudioSource.clip != null &&
                m_ResetSoundAgentEventHandler != null)
            {
            ...
            if (m_BindingEntityLogic != null) UpdateAgentPosition();
        }
