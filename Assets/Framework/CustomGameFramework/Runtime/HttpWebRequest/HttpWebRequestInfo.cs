...
namespace CustomGameFramework.Runtime
{
	...
	public class HttpWebRequestInfo : IReference
	{
		...
		public static HttpWebRequestInfo Create(string uid, int eventId_start, int eventId_success, int eventId_failure, HTTPType httpType, Dictionary<string, string> headers = null,
			string bodyJson = "", SortedDictionary<string, string> query = null)
		{
			HttpWebRequestInfo e = ReferencePool.Acquire<HttpWebRequestInfo>();
			e.UID = uid;
